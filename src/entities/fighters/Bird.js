...
export class Bird extends Fighter {
    constructor(x, y, direction, playerId) {
        super('Bird', x , y, direction, playerId);
        ...
        this.frames = new Map([   
            ...
            // move forwards
            ['walk-1', [[[175, 4817, 508, 594], [238, 474]], PushBox.IDLES, HurtBox.IDLE]],
            ['walk-2', [[[867, 4817, 394, 475], [252, 473]], PushBox.IDLES, HurtBox.IDLE]],
            ['walk-3', [[[1557, 4814, 416, 478], [246, 477]], PushBox.IDLES, HurtBox.IDLE]],
            ['walk-4', [[[2264, 4815, 409, 477], [223, 475]], PushBox.IDLES, HurtBox.IDLE]],
            ['walk-5', [[[206, 5511, 402, 472], [187, 471]], PushBox.IDLES, HurtBox.IDLE]],
            ['walk-6', [[[946, 5509, 383, 473], [141, 471]], PushBox.IDLES, HurtBox.IDLE]],
            ['walk-7', [[[1652, 5508, 342, 477], [133, 475]], PushBox.IDLES, HurtBox.IDLE]],
            ['walk-8', [[[2298, 5511, 366, 474], [186, 471]], PushBox.IDLES, HurtBox.IDLE]],

            // move backwards
            ['backward-1', [[[2298, 5511, 366, 474], [186, 471]], PushBox.IDLES, HurtBox.IDLE]],
            ['backward-2', [[[1652, 5508, 342, 477], [133, 475]], PushBox.IDLES, HurtBox.IDLE]],
            ['backward-3', [[[946, 5509, 383, 473], [141, 471]], PushBox.IDLES, HurtBox.IDLE]],
            ['backward-4', [[[206, 5511, 402, 472], [187, 471]], PushBox.IDLES, HurtBox.IDLE]],
            ['backward-5', [[[2264, 4815, 409, 477], [223, 475]], PushBox.IDLES, HurtBox.IDLE]],
            ['backward-6', [[[1557, 4814, 416, 478], [246, 477]], PushBox.IDLES, HurtBox.IDLE]],
            ['backward-7', [[[867, 4817, 394, 475], [252, 473]], PushBox.IDLES, HurtBox.IDLE]],
            ['backward-8', [[[175, 4817, 508, 594], [238, 474]], PushBox.IDLES, HurtBox.IDLE]],
